...
import GameMap from './components/GameBoard';
...
const getNextValue = (current, speed) =>
  parseInt(current, 10) + parseInt(speed, 10);
...
function App() {
  ...
  useKeyPress(
    'arrowleft',
    () => setLeftOffset(parseInt(leftOffset, 10) - parseInt(speed, 10)),
    [leftOffset, speed]
  );
  useKeyPress(
    'arrowright',
